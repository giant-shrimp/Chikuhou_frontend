...
class SecuringEvacuationRoutesScreen extends StatefulWidget {
  const SecuringEvacuationRoutesScreen({super.key});

  @override
  _SecuringEvacuationRoutesScreenState createState() => _SecuringEvacuationRoutesScreenState();
}

class _SecuringEvacuationRoutesScreenState extends State<SecuringEvacuationRoutesScreen> {
          ...
          Positioned.fill(
            child: InteractiveViewer(
              ...
              child: Transform.scale(
                scale: _scale,
                child: Image.asset(
                  'assets/hazardMap.jpg', // ハザードマップ画像
